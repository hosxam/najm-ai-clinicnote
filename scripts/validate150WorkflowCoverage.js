...
function main() {
  ...
  if (workflows.length !== 154) errors.push(`Expected 154 workflows, got ${workflows.length}`);
  else console.log(`✓ 154 workflows`);

  const allIds = new Set(workflows.map(w => w.workflow_id));
  if (allIds.size !== 154) errors.push(`Duplicate workflow IDs`);
  ...
  if (chipsData.length !== 154) errors.push(`Expected 154 chip groups, got ${chipsData.length}`);
  else console.log(`✓ 154 chip groups`);
  ...
  if (presets.length !== 154) errors.push(`Expected 154 presets, got ${presets.length}`);
  else console.log(`✓ 154 presets`);
  ...
  if (hist.length !== 154) errors.push(`Expected 154 history drafts, got ${hist.length}`);
  else console.log(`✓ 154 history drafts`);
  ...
  if (exam.length !== 154) errors.push(`Expected 154 exam details, got ${exam.length}`);
  else console.log(`✓ 154 exam details`);
  ...
  if (inv.length !== 154) errors.push(`Expected 154 investigation options, got ${inv.length}`);
  else console.log(`✓ 154 investigation options`);
  ...
  if (plans.length !== 154) errors.push(`Expected 154 plan options, got ${plans.length}`);
  else console.log(`✓ 154 plan options`);
