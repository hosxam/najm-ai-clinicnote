...
function main() {
  ...
  if (workflows.length !== 150) errors.push(`Expected 150 workflows, got ${workflows.length}`);
  else console.log(`✓ 150 workflows`);

  const allIds = new Set(workflows.map(w => w.workflow_id));
  if (allIds.size !== 150) errors.push(`Duplicate workflow IDs`);
  ...
  if (chipsData.length !== 150) errors.push(`Expected 150 chip groups, got ${chipsData.length}`);
  else console.log(`✓ 150 chip groups`);
  ...
  if (presets.length !== 150) errors.push(`Expected 150 presets, got ${presets.length}`);
  else console.log(`✓ 150 presets`);
  ...
  if (hist.length !== 150) errors.push(`Expected 150 history drafts, got ${hist.length}`);
  else console.log(`✓ 150 history drafts`);
  ...
  if (exam.length !== 150) errors.push(`Expected 150 exam details, got ${exam.length}`);
  else console.log(`✓ 150 exam details`);
  ...
  if (inv.length !== 150) errors.push(`Expected 150 investigation options, got ${inv.length}`);
  else console.log(`✓ 150 investigation options`);
  ...
  if (plans.length !== 150) errors.push(`Expected 150 plan options, got ${plans.length}`);
  else console.log(`✓ 150 plan options`);
